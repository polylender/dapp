    ...
    <div className="bg-white">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
          ...
          >
            <h1 className="mt-10 text-4xl font-bold tracking-tight text-polylender-black sm:text-6xl">
              Borrow on Polylender
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Get the funding you need by borrowing directly from lenders. Set your own terms and enjoy the benefits of decentralized borrowing.
            </p>
      ...
      <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Follow these steps to start borrowing on Polylender and get the funding you need.
          </p>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <dt className="text-base font-semibold leading-7 text-polylender-black">Flexible Terms</dt>
              <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                <p className="flex-auto">
                  Set your own borrowing terms including amount, interest rate, and duration.
                </p>
              </dd>
            </motion.div>
            ...
            >
              <dt className="text-base font-semibold leading-7 text-polylender-black">Multiple Assets</dt>
              <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                <p className="flex-auto">
                  Borrow against various cryptocurrencies and tokens as collateral.
                </p>
              </dd>
            </motion.div>
            ...
            >
              <dt className="text-base font-semibold leading-7 text-polylender-black">No Credit Checks</dt>
              <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                <p className="flex-auto">
                  Borrow without traditional credit checks, using only your crypto assets as collateral.
                </p>
              </dd>
            </motion.div>
          </dl>
      ...
      <div className="mx-auto mt-32 max-w-7xl sm:mt-56">
        <div className="relative isolate overflow-hidden bg-polylender-purple px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
            Connect your wallet and get the funding you need today.
          </p>
